...
- Final Test: a separate fixed set of 100 newly authored questions using the official 32 / 8 / 40 / 20 composition, including five consecutive four-question Section-C cases.
