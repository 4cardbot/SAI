...
- Section C: 20 questions from five case studies.
...
The bank is generated from curated, syllabus-aligned fact and case-study seeds in `src/data/facts.ts` and `src/data/questionBank.ts`. It produces exactly 2,000 validated question records: 640 A1, 160 A2, 800 B, and 400 C. Questions include topic, difficulty, explanation, source, and time-sensitive `asOf` metadata where applicable.
