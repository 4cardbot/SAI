...
The production bank contains 1716 explicit, high-yield question objects split into four section files: `question_bank/section_a1.json` (900), `section_a2.json` (96), `section_b.json` (480), and `section_c.json` (240). A1 also retains six 150-question group files and a coverage manifest. Section C contains 120 distinct passages, each preserved as a complete case-study group. The app supports section-specific practice sets, a 100-question A1-only test drawn exclusively from the A1 bank, and a full 100-question CBT simulation. Every question adheres to strict anti-pattern standards, eliminating option length disparities and formatting cues. The test engine dynamically shuffles displayed options.
