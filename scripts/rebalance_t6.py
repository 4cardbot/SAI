...
def rebalance_t6():
    ...
    updates = {
        "t6-a1-001": {
            "options": [
                "Slow eccentric velocity decreases total muscle force output (Hill curve)",
        ...
        "t6-a1-002": {
            "options": [
                "Stretch-Shortening Cycle (SSC elastic energy utilization)",
                "Golgi Tendon Organ Reflex (autogenic inhibitory reflex)",
                "Crossed Extensor Reflex (contralateral limb stabilization)",
                "Clasp-Knife Reflex (pathological spasticity manifestation)"
            ]
        },
        "t6-a1-003": {
            "options": [
                "Lifting submaximal loads at maximal intentional acceleration (PAPE)",
        ...
        "t6-a1-004": {
            "options": [
                "Early gains (first 2–4 weeks) are primarily neural; later gains are structural",
                "Early gains are driven by muscle hyperplasia; later gains by hypertrophy",
        ...
        "t6-c-001": {
            "options": [
                "Distal clavicle acute traumatic transverse stress fracture",
                "Posterosuperior Internal Glenohumeral Impingement (PSI)",
                "Acute acromioclavicular joint separation grade III",
                "Biceps brachii long head complete avulsion from labrum"
            ]
        },
        "t6-c-002": {
            "options": [
                "Glenohumeral internal rotation deficit (GIRD) and scapular dyskinesis",
        ...
        "t6-c-004": {
            "options": [
                "Complete immobilization in a sling for four weeks without movement",
                "Serratus Anterior wall slides, Lower Trapezius Y-raises, and cuff drills",
        ...
        "t6-c-005": {
            "options": [
                ...
                "Patellofemoral Pain Syndrome (PFPS lesion)",
                "Pes Anserine Bursitis (PAB lesion)",
                "Adhesive Capsulitis (Frozen Shoulder lesion)"
            ]
        },
        "t6-c-006": {
            "options": [
                "Open-chain knee extensions with heavy weights at 0° to 30° flexion",
                "Complete bed rest and knee immobilization in a rigid cast for eight weeks",
                "Isolated passive hamstring stretching on a table once weekly",
                "Targeted posterolateral hip strengthening and quadriceps coordination"
            ]
        },
        "t6-c-007": {
            "options": [
                "Angiofibroblastic tendinosis (disorganized hypercellular collagen ingrowth)",
                "Complete avulsion fracture of the olecranon process of the proximal ulna",
                "Acute suppurative bacterial infection of the radial collateral ligament",
                "Diffuse autoimmune rheumatoid synovitis of the radiocapitellar joint"
            ]
        },
        "t6-c-008": {
            "options": [
                "Heavy isometric gripping of a steel dumbbell until muscle cramping",
                "Rapid ballistic wrist flexion flailing movements without resistance",
                "Applying ice packs directly over the lateral epicondyle while immobile",
                "Isolated eccentric wrist extensor loading using a flexible resistance bar"
            ]
        },
        "t6-c-009": {
            "options": [
                "Obtain standard ankle radiographs (X-ray series) to rule out a fracture",
                "Apply immediate forceful high-velocity joint manipulation to the ankle",
                "Clear the athlete to return to the basketball court for the remainder",
                "Instruct the athlete to run ten laps around the stadium to disperse edema"
            ]
        },
        "t6-c-010": {
            "options": [
                "Immediate surgical open reconstruction of ligaments within twelve hours",
                "Rigid full-leg plaster casting for eight weeks without weight-bearing",
                "Early protected weight bearing in a functional semi-rigid stirrup brace",
                "Complete bed rest with absolute avoidance of all ankle movements"
            ]
        },
        "t6-c-011": {
            "options": [
                "Acute complete rupture of the anterior cruciate ligament",
                "Osteosarcoma of the proximal femoral diaphysis",
                "Osgood-Schlatter Disease (traction apophysitis of tibial tubercle)",
                "Sever's Disease (traction apophysitis of calcaneal tuberosity)"
            ]
        },
        "t6-c-012": {
            "options": [
                "High-dose corticosteroid injections directly into the patellar tendon weekly",
                "Permanent complete disqualification from all future athletic sports",
                "Activity load management, quadriceps/hamstring flexibility, and strapping",
                "Immediate surgical excision of the entire tibial tuberosity under anesthesia"
            ]
        },
        "t6-c-013": {
            "options": [
                "Medial Tibial Stress Syndrome (MTSS / Grade 1 Bone Stress Injury)",
                "Acute compartment syndrome of the anterior leg (acute compartment)",
                "Rupture of the tibialis posterior tendon (tibialis posterior rupture)",
                "Complete transverse stress fracture through the shaft (tibial fracture)"
            ]
        },
        "t6-c-014": {
            "options": [
                "Rigid high-arched supinated foot with zero subtalar movement",
                "Excessive foot pronation, high peak hip adduction, and high loading rates",
                "Excessive ankle dorsiflexion range exceeding 60° on the lunge test",
                "Hypertrophy of the soleus muscle accompanied by resting hypertension"
            ]
        },
        "t6-c-015": {
            "options": [
                "ACL-RSI scale measures body mass index and has zero psychological relevance",
                "ACL-RSI must be exactly 0% for an athlete to be cleared for competition",
                "ACL-RSI score ≤ 15%, reflecting severe psychological panic and phobia",
                "ACL-RSI score ≥ 65%, reflecting low psychological fear and high confidence"
            ]
        },
        "t6-c-016": {
            "options": [
                "Standing broad jump performed bilaterally landing on a soft mat",
                "Vertical countermovement jump measured on a wooden floor platform",
                "Single Hop, 6-meter Timed Hop, Triple Hop, and Crossover Triple Hop tests",
                "Single-leg calf raises performed on a wooden board until muscular fatigue"
            ]
        },
        "t6-c-017": {
            "options": [
                "Ligamentum Teres of the hip joint (LTH) and ischiofemoral band",
                "Interspinous ligaments of the upper thoracic spine (ITS) and ribs",
                "Posterior Cruciate Ligament (PCL) and Fibular Collateral Ligament",
                "Anterior Cruciate Ligament (ACL) and Medial Collateral Ligament"
            ]
        },
        "t6-c-018": {
            "options": [
                "Static passive stretching held for sixty seconds per muscle group seated",
                "Multi-component warm-up: landing mechanics, core/hip stability, and agility",
                "Heavy maximal 1RM back squatting performed immediately prior to matches",
                "Cardiovascular cycling on a stationary trainer at low intensity for 5 min"
            ]
        },
        "t6-c-019": {
            "options": [
                "Contralateral pars is loaded via extension, side-flexion, and shear force",
                "The right-arm fast bowler always falls onto the left hip during deliveries",
                "Right-arm bowling creates pure compressive loading on right facet joints",
                "The left pars interarticularis has zero bony trabeculae or cortical bone"
            ]
        },
        "t6-c-020": {
            "options": [
                "Forcing the bowler to bowl with the non-dominant arm permanently",
                "Instructing the bowler to jump 2 meters high during pre-delivery impact",
                "Increasing shoulder counter-rotation to >60° during the delivery stride",
                "Eliminating mixed bowling action by aligning shoulders and hips in plane"
            ]
        }
    }
    ...
    print("Updated mock_test_6.json successfully!")

if __name__ == '__main__':
    rebalance_t6()

# re-run with final 19 fixes
with open('mock_tests/mock_test_6.json') as f:
    qs = json.load(f)
...
for q in qs:
    ...
    if q['id'] == 't6-a1-003':
        q['options'] = [
            "Lifting submaximal loads at maximal intentional acceleration",
            "Lifting supramaximal loads with slow eccentric tempos and holds",
            "Lifting near-maximal loads to absolute concentric failure daily",
            "Lifting light endurance loads for continuous multi-minute sets"
        ]
    ...
    if q['id'] == 't6-b-007':
        q['options'] = [
            "Alfredson eccentric heel-drop protocol (3x15 straight and bent knee)",
            "Stanish eccentric tendon loading protocol (3x10 progressive speed)",
            "Silbernagel combined loading protocol (3x12 eccentric-concentric)",
            "Cook and Purdam isometric loading protocol (5x45s sustained holds)"
        ]
    if q['id'] == 't6-b-021':
        q['options'] = [
    ...
    if q['id'] == 't6-c-001':
        q['options'] = [
            "Distal clavicle acute traumatic stress fracture",
            "Posterosuperior Internal Glenohumeral Impingement",
            "Acute acromioclavicular joint separation grade III",
            "Biceps brachii long head complete labral avulsion"
        ]
    if q['id'] == 't6-c-002':
        q['options'] = [
            "Glenohumeral internal rotation deficit and scapular dyskinesis",
            "Excessive internal rotation with restricted external rotation",
            "Pectoralis major contracture with anterior clavicle subluxation",
            "Supraspinatus tendon complete rupture with humeral head migration"
        ]
    if q['id'] == 't6-c-007':
        q['options'] = [
            "Angiofibroblastic tendinosis with sensory nerve ingrowth",
            "Complete avulsion fracture of the proximal olecranon",
            "Acute suppurative bacterial infection of the radial ligament",
            "Diffuse autoimmune rheumatoid synovitis of the joint"
        ]
    if q['id'] == 't6-c-009':
        q['options'] = [
            "Obtain standard ankle radiographs to rule out a fracture",
            "Apply immediate forceful high-velocity joint manipulation",
            "Clear the athlete to return to the basketball court immediately",
            "Instruct the athlete to run ten laps around the track"
        ]
    if q['id'] == 't6-c-011':
        q['options'] = [
            "Acute complete rupture of the anterior cruciate ligament",
            "Osteosarcoma of the proximal femoral diaphysis lesion",
            "Osgood-Schlatter Disease (tibial tubercle apophysitis)",
            "Sever's Disease (calcaneal tuberosity apophysitis)"
        ]
    if q['id'] == 't6-c-013':
        q['options'] = [
            "Medial Tibial Stress Syndrome (MTSS bone injury)",
            "Acute compartment syndrome of leg (ACS condition)",
            "Rupture of tibialis posterior tendon (TPT injury)",
            "Complete transverse tibial stress fracture (TSF injury)"
        ]
    if q['id'] == 't6-c-015':
        q['options'] = [
            "ACL-RSI scale score is 0% (indicates complete physical readiness)",
            "ACL-RSI scale score is 10% (indicates minimal psychological readiness)",
            "ACL-RSI scale score is 30% (indicates severe psychological fear)",
            "ACL-RSI scale score is 65% (indicates high psychological readiness)"
        ]
    if q['id'] == 't6-c-016':
        q['options'] = [
            "1 single standing broad jump performed bilaterally on mat",
            "1 single vertical countermovement jump measured on floor",
            "4 hop tests: Single Hop, 6m Timed, Triple Hop, Crossover Hop",
            "20 single-leg calf raises performed on a wooden board"
        ]

with open('mock_tests/mock_test_6.json', 'w') as f:
    json.dump(qs, f, indent=2)

print("Test 6 fully patched!")
...
for q in qs:
    if q['id'] == 't6-c-011':
        q['options'] = [
            "Anterior Cruciate Ligament Rupture (acute ACL tear)",
            "Proximal Femoral Osteosarcoma (malignant bone tumor)",
            "Osgood-Schlatter Disease (tibial tubercle apophysitis)",
            "Sever's Disease (calcaneal tuberosity apophysitis)"
        ]
